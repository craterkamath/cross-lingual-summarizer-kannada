...
class SentenceCollection(object):
    ...
    def translate(self, sourceLang, targetLang, replaceOriginal=False, pre_translations = []):
        """
        Translate sentences
        ...
        if pre_translations:
            ...
            translation = m.translate(text.encode("utf-8"), targetLang, sourceLang).encode("utf-8")
